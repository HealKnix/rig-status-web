...
--     -----------------------------------------------------------------------------------------------------------------
       ...
       (9,  'Расход на входе',                   'inlet_flow_rate',        'л/с',     1, 150, 300,   1, 1, 2),
       (10, 'Поток на выходе',                   'outlet_flow_rate',       'л/с',     1, 150, 300,   1, 1, 2),
       (11, 'Давление манифольда',               'manifold_pressure',      'кПа',     1, 20,  50,    1, 1, 2),
       (12, 'Перепад давления',                  'pressure_drop',          'кПа',     1, 20,  50,    1, 1, 2),
--     -----------------------------------------------------------------------------------------------------------------
       ...
       (16, 'Расход на входе',                   'inlet_flow_rate',        'л/с',     1, 150, 300,   1, 1, 3),
       (17, 'Поток на выходе',                   'outlet_flow_rate',       'л/с',     1, 150, 300,   1, 1, 3),
       (18, 'Давление манифольда',               'manifold_pressure',      'кПа',     1, 20,  50,    1, 1, 3),
       (19, 'Перепад давления',                  'pressure_drop',          'кПа',     1, 20,  50,    1, 1, 3),
--     -----------------------------------------------------------------------------------------------------------------
       (20, 'Осевая нагрузка',                   'axial_load',             'кН',      1, 10,  50,    1, 1, 4),
       (21, 'Частота вращения вала',             'shaft_rotation_speed',   'об/мин',  1, 50,  150,   1, 1, 4),
...
--     -----------------------------------------------------------------------------------------------------------------
       ...
       (30, 'Водоотдача',                        'water_cut',              'м³/сек',  1, 2,   15,    1, 1, 5),
--     -----------------------------------------------------------------------------------------------------------------
       (31, 'Статус',                            'mud_pump_status',        '',        1, 0,   100,   1, 1, 6),
       (32, 'Статус работы ОРБ',                 'left_circuit_pressure',  '',        1, 0,   100,   1, 1, 6),
       (33, 'Давление в левом рабочем конутре',  'left_circuit_pressure',  'кПа',     1, 50,  150,   1, 1, 6),
       (34, 'Давление в правом рабочем конутре', 'right_circuit_pressure', 'кПа',     1, 50,  150,   1, 1, 6),
       (35, 'Давление в стояночном тормозе',     'parking_brake_pressure', 'МПа',     1, 5,   15,    1, 1, 6),
--     -----------------------------------------------------------------------------------------------------------------
